...
import { InputContent } from "@/components/document/content/InputContent";
import { InputForm } from "@/components/forms/InputForm";
import type { ApprovalHistoryEntry, Attachment, InputDocument, Standard } from "@/lib/types";
import type { InputFormValues } from "@/lib/schemas/input";

const FORM_TITLE = "개발입력서 (F702-2)";
...
export default function InputDocumentPage() {
    ...
    return (
      <div>
        ...
        <PrintLayout formTitle={FORM_TITLE} projectName={projectName} header={doc.header}>
          <InputContent doc={doc} standardNames={standardNames} variant="print" />
        </PrintLayout>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {viewMode === "detail" && doc ? (
        <InputContent doc={doc} standardNames={standardNames} variant="detail" />
      ) : (
